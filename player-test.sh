...
ffmpeg -ss 00:00:00 -t $(($FRAMES / $frame_rate)) -i $VIDEOPATH -s ${small_width}x${small_height} -v quiet -vcodec rawvideo -f rawvideo -pix_fmt yuv420p pipe:1 | # 原始视频缩放后转rawvideo
